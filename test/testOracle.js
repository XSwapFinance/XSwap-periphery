...
const { getPoolParts, getXSwapFactory, attachXSwapPool } = require("./funcs.js")
...
describe("test uniswap price oracle", function () {
    ...
    beforeEach(async function() {
        ...
        nflm = await getNFTLiquidityManager(xswapFactory.address, wethAddr);
        console.log("get nflm");
        swap = await getSwap(xswapFactory.address, wethAddr);
        ...
        pool = await attachXSwapPool(poolXYAddr)
